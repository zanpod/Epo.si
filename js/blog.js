...
function blogCardHtml(p, i = 0) {
  const img = p.cover_image_url
    ? `<img src="${optimizedImg(p.cover_image_url, 500)}" data-fallback="${blogEscAttr(p.cover_image_url)}" alt="${blogEscAttr(p.title)}" class="blog-card-image" loading="lazy" decoding="async">`
    : `<div class="blog-card-image-placeholder"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><line x1="10" y1="9" x2="8" y2="9"/></svg></div>`;
...
function blogFeaturedHtml(p) {
  const img = p.cover_image_url
    ? `<img src="${optimizedImg(p.cover_image_url, 900)}" data-fallback="${blogEscAttr(p.cover_image_url)}" alt="${blogEscAttr(p.title)}" class="blog-featured-image" decoding="async">`
    : `<div class="blog-featured-image-placeholder"><svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><line x1="10" y1="9" x2="8" y2="9"/></svg></div>`;
...
function renderArticle(container, p) {
  ...
  container.innerHTML = `
    ...
    ${p.cover_image_url ? `<img src="${optimizedImg(p.cover_image_url, 900)}" data-fallback="${blogEscAttr(p.cover_image_url)}" alt="${blogEscAttr(p.title)}" class="article-cover" decoding="async">` : ''}
